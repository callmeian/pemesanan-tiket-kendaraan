...
import com.example.pemesanantiket.databinding.ActivityInputDataBinding
...
class DataKeretaActivity : AppCompatActivity() {
    ...
    private val inputDataViewModel by viewModels<InputDataViewModel> {
        InputDataViewModel.Factory
    }
        ...
        binding.btnCheckout.setOnClickListener { v: View? ->
            ...
            if (sNama.isEmpty() || sTanggal.isEmpty() || sTelp.isEmpty()
                ...
                if (sAsal == "Jakarta" && sTujuan == "Jakarta"
                    ...
                    inputDataViewModel.addDataPemesanan(
                        sNama,
                        sAsal,
                        sTujuan,
                        sTanggal,
